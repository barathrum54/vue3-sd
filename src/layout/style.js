...
const MainWrapper = Styled('div', props)`
    ...
    .striking-logo{
        ...
        img{
            max-width: ${({ theme }) => (theme.topMenu ? '2000px' : '200px')};
            width: 100%;
        }
        &.top-menu{
    ...
    .navbar-brand{
        ...
        align-items: center;
        button{
            padding: ${({ theme }) => (theme.rtl ? '0 0px 0 25px !important' : '0 25px 0 15px !important')};
            line-height: 0;0
            ...
            .ant-menu{
                ...
                .ant-menu-item{
                    ...
                    a{
                        ...
                        align-items: center;
                        ${({ theme }) => (theme.rtl ? 'justify-content: flex-end' : '')};
                        .feather{
                            width: 16px;
                            color: ${({ theme }) => theme['extra-light-color']};
                        }
                    ...
                    .ant-menu-submenu{
                        ...
                        .ant-menu-submenu-title{
                            ...
                            .ant-menu-title-content{
                                ${({ theme }) => (theme.rtl ? 'display: inline-flex' : '')};
                            }
                        }
                    }
                    .ant-menu-item{
...
export { MainWrapper, SmallScreenAuthInfo, SmallScreenSearch, ModeSwitch, TopMenuStyle, TopMenuSearch, Aside, Content };
