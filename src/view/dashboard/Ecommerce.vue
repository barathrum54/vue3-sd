              ...
              <CardBarChart2>
                ...
                <p>
                  <span class="growth-upward">
                    <sdFeatherIcons type="arrow-up" /> 25%
                  </span>
              ...
              <CardBarChart2>
                ...
                <p>
                  <span class="growth-downward">
                    <sdFeatherIcons type="arrow-down" /> 25%
                  </span>
                  <span>Since last week</span>
                </p>
              </CardBarChart2>
...
const TotalRevenue = defineAsyncComponent(() =>
  import("./overview/ecommerce/TotalRevenue")
);
const RevenueGenerated = defineAsyncComponent(() =>
  import("./overview/ecommerce/RevenueGenerated")
);
...
const SalesByLocation = defineAsyncComponent(() =>
  import("./overview/ecommerce/SalesByLocation")
);
const RevenueByDevice = defineAsyncComponent(() =>
  import("./overview/ecommerce/RevenueByDevice")
);
