            ...
            <a-row :gutter="15">
              ...
              <a-col :xxl="4" :lg="9" :xs="24">
                <div class="table-toolbox-actions">
                  ...
                  <sdButton size="small" type="primary"> + Add Order </sdButton>
                </div>
              </a-col>
            </a-row>
          </TopToolBox>
        ...
        <a-col :md="24">
          <TableWrapper class="table-seller table-responsive">
            <a-table
              ...
              :columns="columns"
              :pagination="{ pageSize: 7, showSizeChanger: true, total: sellers ? sellers.length : 20 }"
            />
          </TableWrapper>
        </a-col>
      </a-row>
