  ...
  <Main>
    <a-row :gutter="25">
      <a-col :sm="24" :xs="24">
        <ExportStyleWrap>
          <sdCards headless>
            <div class="sDash_export-box">
              <template v-if="selectedRows.length">
                <sdButton class="btn-export" @click="showModal" type="primary">
                  Export
                </sdButton>
                <sdModal
                  title="Export File"
                  wrapclass="sDash_export-wrap"
            ...
            <div
              class="sDash_export-file-table table-bordered table-responsive"
            >
              <a-table
