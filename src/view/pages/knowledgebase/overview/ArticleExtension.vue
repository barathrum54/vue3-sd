      ...
      <a-row>
        <a-col :md="8" :sm="12" :xs="24">
          <div class="sDash_article-tab-signle">
            <h2 class="sDash_article-tab-signle__title">Introduction to Extension</h2>
            <ul class="sDash_article-tab-signle__list">
              <li>
                <router-link to="/page/knowledgebase/single/1">Log in and out of Extensions</router-link>
              </li>
              <li>
