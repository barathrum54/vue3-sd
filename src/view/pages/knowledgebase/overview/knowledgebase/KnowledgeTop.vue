  ...
  <div>
    <KnowledgebaseTopWrap>
      <div class="sDash_knowledgetop">
        <h2 class="sDash_knowledgetop__title">Hi, How can we help?</h2>
        ...
        <div class="sDash_knowledgetop__popular--topics">
          <ul>
            <li>
              <span class="popular-topics-title">Popular topics:</span>
            </li>
            <li>
              <router-link to="#">Message formatting</router-link>
            </li>
            <li>
