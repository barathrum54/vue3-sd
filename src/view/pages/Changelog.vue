      ...
      <a-row :gutter="25">
        <a-col :xxl="19" :md="16" :xs="24">
          <ChangelogWrapper>
            <sdCards>
              <template #title>
                <span class="v-num">Version {{ versions[0].version }} </span> <span class="sign"> - </span>
                ...
                <div class="version-list">
                  <div class="version-list__single" v-if="versions[0].new">
                    ...
                    <ul class="version-success">
                      <li v-for="(item, index) in versions[0].new" :key="index + 1">{{ item }}</li>
                    </ul>
                  </div>
                  ...
                  <div class="version-list__single" v-if="versions[0].fixed">
                    ...
                    <ul class="version-info">
                      <li v-for="(item, index) in versions[0].fixed" :key="index + 1">{{ item }}</li>
                    </ul>
                  </div>
                  <div class="version-list__single" v-if="versions[0].updated">
                    ...
                    <ul class="version-primary">
                      <li v-for="(item, index) in versions[0].updated" :key="index + 1">{{ item }}</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="changelog-accordion">
                <a-collapse accordion>
                  <a-collapse-panel v-for="(version, index) in versions" :key="index + 1">
                    <template #header>
                      <span class="v-num">Version {{ version.version }} </span> <span class="sign">-</span>
                    ...
                    <div class="version-list">
                      <div class="version-list__single" v-if="version.new">
                        ...
                        <ul class="version-success">
                          <li v-for="(item, index) in version.new" :key="index + 1">{{ item }}</li>
                        </ul>
                      </div>
                      ...
                      <div class="version-list__single" v-if="version.fixed">
                        ...
                        <ul class="version-info">
                          <li v-for="(item, index) in version.fixed" :key="index + 1">{{ item }}</li>
                        </ul>
                      </div>
                      <div class="version-list__single" v-if="version.updated">
                        ...
                        <ul class="version-primary">
                          <li v-for="(item, index) in version.updated" :key="index + 1">{{ item }}</li>
                        </ul>
                      </div>
                    </div>
                  </a-collapse-panel>
