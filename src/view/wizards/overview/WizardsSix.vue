      ...
      <WizardSix>
        ...
        >
                ...
                <a-row justify="center">
                  <a-col :xs="24">
                    <div class="create-account-form">
                      <sdHeading as="h4"
                        >1. Please Create Your Account</sdHeading
                      >
          ...
          <template #review>
            ...
            >
              <div
                class="atbd-review-order theme-light"
                :style="{ width: '100%' }"
              >
                ...
                >
                  ...
                  <div class="atbd-review-order__single">
                    <sdCards headless>
                      ...
                      <a-row justify="end">
                        <a-col :sm="14" :xs="24" :offset="!rtl ? 10 : 0">
                          <OrderSummary>
...
import Steps from "@/components/springDash/steps/steps";
