...
const lightBlueColor = "rgba(95, 183, 242, 0.2)";
const lightBlueTextColor = "rgba(95, 183, 242, 1)";
const lightPurpleColor = "rgba(95, 99, 242, 0.2)";
const lightPurpleTextColor = "rgba(95, 99, 242, 1)";
const darkPurpleColor = "#5F81F2";
const darkPurpleTextColor = "#fff";
const advertPurpleColor = "#DEE0F6";
const advertPurpleTextColor = "#5F63F2";
const advertPurpleSecondColor ="#F1E8FF";
const advertPurpleSecondTextColor ='#A069FF';
const advertYellowColor = "#F6ECDE";
const advertYellowTextColor = "#F2B75F";
const advertRedColor = "#F6DEDE";
const advertRedTextColor = "#F25F5F";
const advertHighRedColor="#F55656";
const advertHighRedTextColor="#fff"
const advertCheckedColor="#C1E2C2";
const advertCheckedTextColor="#30A830";
...
const btnsm = "36px";
const btnxs = "29px";
const faqSiparisler="#2C99FF";
const faqHesapAyarlari="#FA8B0C";
const faqSohbetSistemi="#20C997";
const faqBildirimSistemi="#FF69A5";
const faqIlanIslemleri="#5F63F2";
const faqDiger="#FF4D4F";
...
const theme = {
  ...
  "lightBlue-color": lightBlueColor, // light blue color for all components
  "lightBlueText-color": lightBlueTextColor,
  "lightPurple-color": lightPurpleColor,
  "lightPurpleText-color": lightPurpleTextColor,
  "darkPurple-color": darkPurpleColor,
  "darkPurpleText-color": darkPurpleTextColor,
  "advertPurple-color": advertPurpleColor,
  "advertPurpleText-color": advertPurpleTextColor,
  "advertPurpleSecond-color":advertPurpleSecondColor,
  "advertPurpleSecondText-color":advertPurpleSecondTextColor,
  "advertYellow-color": advertYellowColor,
  "advertYellowText-color": advertYellowTextColor,
  "advertRed-color": advertRedColor,
  "advertRedText-color": advertRedTextColor,
  "advertHighRed-color":advertHighRedColor,
  "advertHighRedText-color":advertHighRedTextColor,
  "advertChecked-color":advertCheckedColor,
  "advertCheckedTextColor":advertCheckedTextColor,
  ...
  //shop
  shops_dailyOverviewGradientPrimary: "#69AAFF",
  shops_dailyOverviewGradientSecondary: "#AD73DF",
  shops_lightThemeBorderColorPrimary: "#E5E5E5",
  shops_lightThemeImageBackgroundColor: "#F4F5F7",


  //faq
  "faq-ilanIslemleri":faqIlanIslemleri,
  "faq-bildirimSistemi":faqBildirimSistemi,
  "faq-hesapAyarlari":faqHesapAyarlari,
  "faq-sohbetSistemi":faqSohbetSistemi,
  "faq-siparisler":faqSiparisler,
  "faq-diger":faqDiger,
