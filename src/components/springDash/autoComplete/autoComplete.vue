<template>
  ...
  >
    <template v-if="myData.length" #options>
      <a-select-option v-for="item in myData.slice(0,10)" :key="item.Title">
        {{ item.Title }}
      </a-select-option>
    </template>
    <template v-else #options>
      <a-select-option key="Sonuç Bulunamadı!"> Sonuç Bulunamadı! </a-select-option>
    </template>
    <slot></slot>
  </AutoCompleteStyled>
  <AutoCompleteStyled
  ...
  >
    ...
    <template v-else #options>
      <a-select-option key="Sonuç Bulunamadı">
        Sonuç Bulunamadı!
      </a-select-option>
